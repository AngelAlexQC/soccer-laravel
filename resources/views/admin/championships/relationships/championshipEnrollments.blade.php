...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-championshipEnrollments">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($enrollments as $key => $enrollment)
                        <tr data-entry-id="{{ $enrollment->id }}">
                            ...
                            <td>
                                @foreach($enrollment->players as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-championshipEnrollments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
