...
<div class="card">
    ...
    <div class="tab-content p-3">
        <div class="tab-pane" role="tabpanel" id="local_matches">
            @includeIf('admin.enrollments.relationships.localMatches',
            ['matches' => $enrollment->localMatches])
        </div>
        <div class="tab-pane" role="tabpanel" id="away_matches">
            @includeIf('admin.enrollments.relationships.awayMatches', ['matches'
            => $enrollment->awayMatches])
        </div>
    </div>
</div>
