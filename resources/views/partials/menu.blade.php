    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.clubs.index") }}"
                class="c-sidebar-nav-link {{ request()->is("admin/clubs") || request()->is("admin/clubs/*") ? "c-active" : "" }}">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.championships.index") }}"
                class="c-sidebar-nav-link {{ request()->is("admin/championships") || request()->is("admin/championships/*") ? "c-active" : "" }}">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.players.index") }}"
                class="c-sidebar-nav-link {{ request()->is("admin/players") || request()->is("admin/players/*") ? "c-active" : "" }}">
                <i class="fa-fw far fa-futbol c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.enrollments.index") }}"
                class="c-sidebar-nav-link {{ request()->is("admin/enrollments") || request()->is("admin/enrollments/*") ? "c-active" : "" }}">
