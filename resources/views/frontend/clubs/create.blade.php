    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clubs.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="picture">{{ trans('cruds.club.fields.picture') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.club.fields.picture_helper') }}</span>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    url: '{{ route('frontend.clubs.storeMedia') }}',
    maxFilesize: 2, // MB
    ...
    init: function () {
@if(isset($club) && $club->picture)
      var file = {!! json_encode($club->picture) !!}
