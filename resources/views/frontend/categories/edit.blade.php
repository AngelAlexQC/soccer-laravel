                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.categories.update", [$category->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="min_age" id="min_age" value="{{ old('min_age', $category->min_age) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_age" id="max_age" value="{{ old('max_age', $category->max_age) }}" step="1">
