...
class ChampionshipController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.championships.index', compact('championships', 'categories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.championships.create', compact('categories'));
    }
    ...
    public function store(StoreChampionshipRequest $request)
    {
        ...
        return redirect()->route('frontend.championships.index');
    }
    ...
    public function edit(Championship $championship)
    {
        ...
        return view('frontend.championships.edit', compact('categories', 'championship'));
    }
    ...
    public function show(Championship $championship)
    {
        ...
        return view('frontend.championships.show', compact('championship'));
    }
